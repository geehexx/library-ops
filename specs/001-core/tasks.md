...
- [ ] T001 Validate meta-system readiness: required toolchain, Codex config, MCPs, hooks, skills, ADRs, PRD, explicit coordinator-first bounded delegation, bad-anchor avoidance, and no-junk checks.

"""Catalog manager helpers and write orchestration."""
...
from libraryops.catalog.querysets import BibliographicWorkQuerySet
...
def _edition_state(edition: catalog_models.BookEdition) -> dict[str, object]:
    ...
    return {
        ...
        "cover_image": edition.cover_image.name or None,
...
def _apply_edition_updates(
    edition: catalog_models.BookEdition,
    *,
    work: catalog_models.BibliographicWork | None = None,
    publisher: str | None = None,
    publication_year: int | None = None,
    language: str | None = None,
    isbn: str | None = None,
    cover_url: str | None = None,
    cover_image: Any | None = None,
...
class BibliographicWorkManager(models.Manager["catalog_models.BibliographicWork"]):
    ...
    def create_work(
        ...
        *,
        ...
        title: str,
        description: str = "",
    ) -> catalog_models.BibliographicWork:
    ...
    def update_work(
        ...
        *,
        actor: User,
        work: catalog_models.BibliographicWork,
        title: str | None = None,
        description: str | None = None,
    ) -> catalog_models.BibliographicWork:
    ...
    def create_foundation_record(
        ...
        *,
        ...
        contributor, _ = catalog_models.Contributor.objects.get_or_create(
            normalized_name=catalog_models.normalize_name(data.contributor_name),
            defaults={"name": data.contributor_name},
        )
        catalog_models.WorkContributor.objects.create(
            work=work,
            contributor=contributor,
            role=data.contributor_role,
        )
        edition = catalog_models.BookEdition.objects.create(
            work=work,
            isbn=data.isbn,
...
class BookEditionManager(models.Manager["catalog_models.BookEdition"]):

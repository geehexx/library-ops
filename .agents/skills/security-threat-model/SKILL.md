...
description: "Use when the user explicitly asks to threat model a codebase or path, enumerate abuse paths, or perform AppSec threat modeling. This skill builds a repository-grounded threat model covering trust boundaries, assets, attacker capabilities, abuse paths, and mitigations. Do not trigger for general architecture summaries, code review, or non-security design work."
---
